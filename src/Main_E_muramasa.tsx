  ...
  return (
    <Box>
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(7, 1fr)',gap:0
        ...
        <Item sx={{ gridRow: '1', gridColumn: 'span 5', textAlign:"left"}}>村正</Item>
      </Box>
      ...
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(8, 1fr)',gap:0,}}>
        ...
        <Item sx={{ gridRow: '1', gridColumn: '3' }}>100</Item>
      ...
      <Item sx={{ gridRow: '1', gridColumn: '1' , fontSize: "12px"}}>{/* 呪攻＋ */}</Item>
        ...
        <Item sx={{ gridRow: '2', gridColumn: '5' , fontSize: "12px"}}>{/* AGI */}AGI+5</Item>
...
export default Main_E_muramasa;