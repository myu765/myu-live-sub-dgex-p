  ...
  return (
    <Box>
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(7, 1fr)',gap:0
        ...
        <Item sx={{ gridRow: '1', gridColumn: 'span 5', textAlign:"left"}}>クリスタルファー</Item>
      </Box>
      ...
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(8, 1fr)',gap:0,}}>
        ...
        <Item sx={{ gridRow: '1', gridColumn: '6' }}>3</Item>
...
export default Main_E_crystal_fur;