...
function Main_E_fran_no_kubikazari () {
  return (
    <Box>
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(7, 1fr)',gap:0
        ...
        <Item sx={{ gridRow: '1', gridColumn: 'span 5', textAlign:"left"}}>フランの首飾り</Item>
      </Box>
      ...
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(8, 1fr)',gap:0,}}>
        ...
        <Item sx={{ gridRow: '1', gridColumn: '5' }}>4</Item>
        <Item sx={{ gridRow: '1', gridColumn: '6' }}>2</Item>
        <Item sx={{ gridRow: '1', gridColumn: '7' }}>8</Item>
        <Item sx={{ gridRow: '1', gridColumn: '8' }}>6%</Item>
      </Box>
      ...
      <Item sx={{ gridRow: '1', gridColumn: '1' , fontSize: "12px"}}>{/* 呪攻＋ */}呪攻＋</Item>
        ...
        <Item sx={{ gridRow: '2', gridColumn: '2' , fontSize: "12px"}}>{/* INT */}INT+?</Item>
      ...
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(8, 1fr)',gap:0,}}>
        ...
        入手方法：クエスト/盗まれた〇✕△で集める
        </Item>
        <Item sx={{ gridRow: '3', gridColumn: 'span 8', textAlign:"left", fontSize: "13px", fontWeight:"500", color: 'error.main' }}>
        ※クエスト/盗まれた〇✕△達成で失われる
        </Item>
      </Box>
    </Box>
...
export default Main_E_fran_no_kubikazari;