  ...
  return (
    <Box>
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(7, 1fr)',gap:0
        ...
        <Item sx={{ gridRow: '1', gridColumn: 'span 5', textAlign:"left"}}>エクスブランド</Item>
      </Box>
      ...
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(8, 1fr)',gap:0,}}>
        ...
        <Item sx={{ gridRow: '1', gridColumn: '3' }}>240</Item>
        <Item sx={{ gridRow: '1', gridColumn: '4' }}>2</Item>
        <Item sx={{ gridRow: '1', gridColumn: '5' }}>1</Item>
        <Item sx={{ gridRow: '1', gridColumn: '6' }}>1</Item>
        <Item sx={{ gridRow: '1', gridColumn: '7' }}>5</Item>
      ...
      <Item sx={{ gridRow: '1', gridColumn: '1' , fontSize: "12px"}}>{/* 呪攻＋ */}呪攻＋</Item>
        ...
        <Item sx={{ gridRow: '2', gridColumn: '1' , fontSize: "12px"}}>{/* STR */}STR+5</Item> 
        ...
        <Item sx={{ gridRow: '2', gridColumn: '5' , fontSize: "12px"}}>{/* AGI */}AGI+?</Item>
        <Item sx={{ gridRow: '2', gridColumn: '6' , fontSize: "12px"}}>{/* LUC */}LUC+5</Item>
      ...
      <Box sx={{display:'grid',gridTemplateColumns: 'repeat(6, 1fr)',gap:0,}}>
        ...
        <Item sx={{ gridRow: '4', gridColumn: 'span 6', textAlign:"left", color: 'success.main', fontSize: "13px" }}>
        ソルゲイズを防ぐ（失われない）
        </Item>
      </Box>
      <Divider textAlign="left" sx={{width:"270px",my:"2px"}}/>
